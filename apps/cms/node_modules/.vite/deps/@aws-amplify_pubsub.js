...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/Providers/constants.mjs
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/types/PubSub.mjs
var CONTROL_MSG;
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/Providers/PubSub.mjs
var logger = new ConsoleLogger("AbstractPubSubProvider");
var AbstractPubSub = class {
  constructor(options) {
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/_virtual/_commonjsHelpers.mjs
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};

// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/_virtual/paho-mqtt2.mjs
var pahoMqtt = { exports: {} };

// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/vendor/paho-mqtt.mjs
var pahoMqtt2 = pahoMqtt.exports;
var hasRequiredPahoMqtt;
function requirePahoMqtt() {
  if (hasRequiredPahoMqtt) return pahoMqtt.exports;
  ...
  (function(module, exports) {
    ...
    })(pahoMqtt2, function LibraryFactory() {
      var PahoMQTT = (function(global2) {
        var version = "@VERSION@-@BUILDLEVEL@";
        var localStorage = (function() {
          try {
            if (global2.localStorage) return global2.localStorage;
          } catch (e) {
            var data = {};
            return {
        ...
        ClientImpl.prototype.subscribe = function(filter2, subscribeOptions) {
          this._trace("Client.subscribe", filter2, subscribeOptions);
          if (!this.connected)
            throw new Error(format(ERROR.INVALID_STATE, ["not connected"]));
          var wireMessage = new WireMessage(MESSAGE_TYPE.SUBSCRIBE);
          wireMessage.topics = filter2.constructor === Array ? filter2 : [filter2];
          if (subscribeOptions.qos === void 0) subscribeOptions.qos = 0;
        ...
        ClientImpl.prototype.unsubscribe = function(filter2, unsubscribeOptions) {
          this._trace("Client.unsubscribe", filter2, unsubscribeOptions);
          if (!this.connected)
            throw new Error(format(ERROR.INVALID_STATE, ["not connected"]));
        ...
        var Client = function(host, port, path, clientId) {
          ...
          this.subscribe = function(filter2, subscribeOptions) {
            if (typeof filter2 !== "string" && filter2.constructor !== Array)
              throw new Error("Invalid argument:" + filter2);
            ...
            client.subscribe(filter2, subscribeOptions);
          };
          this.unsubscribe = function(filter2, unsubscribeOptions) {
            if (typeof filter2 !== "string" && filter2.constructor !== Array)
              throw new Error("Invalid argument:" + filter2);
            ...
            client.unsubscribe(filter2, unsubscribeOptions);
          };
  ...
  return pahoMqtt.exports;
}

// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/_virtual/paho-mqtt.mjs
var pahoMqttExports = requirePahoMqtt();

// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/utils/ReachabilityMonitor/index.mjs
var ReachabilityMonitor = () => new Reachability().networkMonitor();

// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/utils/ConnectionStateMonitor.mjs
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/utils/ReconnectionMonitor.mjs
var ReconnectEvent;
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/Providers/MqttOverWS.mjs
var logger2 = new ConsoleLogger("MqttOverWS");
function mqttTopicMatch(filter2, topic) {
  const filterArray = filter2.split("/");
...
var dispatchPubSubEvent = (payload) => {
  Hub.dispatch("pubsub", payload, "PubSub", AMPLIFY_SYMBOL);
};
var topicSymbol = typeof Symbol !== "undefined" ? /* @__PURE__ */ Symbol("topic") : "@@topic";
var MqttOverWS = class extends AbstractPubSub {
  constructor(options = {}) {
    ...
    this._topicObservers = /* @__PURE__ */ new Map();
    this._clientIdObservers = /* @__PURE__ */ new Map();
  ...
  async newClient({ url, clientId }) {
    ...
    const client = new pahoMqttExports.Client(url, clientId);
  ...
  async publish({ topics, message }) {
    ...
    if (client) {
      ...
      logger2.debug("Publishing to topic(s) failed", targetTopics.join(","), message);
    }
  }
    ...
    return new Observable((observer) => {
      ...
      (async () => {
        const getClient = async () => {
          try {
            ...
            logger2.debug("Error forming connection", e);
          }
        };
        await getClient();
      ...
      return async () => {
        ...
        if (client) {
          ...
          targetTopics.forEach((topic) => {
            const observersForTopic = this._topicObservers.get(topic) || /* @__PURE__ */ new Set();
...
// ../../node_modules/.pnpm/@aws-amplify+pubsub@6.1.69_@aws-amplify+core@6.16.1/node_modules/@aws-amplify/pubsub/dist/esm/Providers/AWSIot.mjs
var SERVICE_NAME = "iotdevicegateway";
var AWSIoT = class extends MqttOverWS {
  constructor(options = {}) {
    super(options);
  }
  get region() {
...
//# sourceMappingURL=@aws-amplify_pubsub.js.map
