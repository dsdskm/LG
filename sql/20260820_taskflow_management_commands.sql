...
VALUES
  ...
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '새 태스크플로우를 생성합니다.',
      'notFoundText', '새 태스크플로우를 생성할 수 없습니다.',
      'description', 'Task Flow 상세 화면에서도 새 작업 흐름을 생성한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 복제합니다.',
      'notFoundText', '복사할 태스크플로우를 찾지 못했습니다.',
      'description', 'Task Flow 상세 화면에서 지정한 Task Flow를 복제한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 삭제합니다.',
      'notFoundText', '삭제할 태스크플로우를 찾지 못했습니다.',
      'description', 'Task Flow 상세 화면에서 지정한 Task Flow를 삭제한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 수정합니다.',
      'notFoundText', '수정할 태스크플로우를 찾지 못했습니다.',
      'description', 'Task Flow 상세 화면에서 지정한 Task Flow를 수정 화면으로 연다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '새 태스크플로우를 생성합니다.',
      'notFoundText', '새 태스크플로우를 생성할 수 없습니다.',
      'description', '캔버스 화면에서도 새 작업 흐름을 생성한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 복제합니다.',
      'notFoundText', '복사할 태스크플로우를 찾지 못했습니다.',
      'description', '캔버스 화면에서 지정한 Task Flow를 복제한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 삭제합니다.',
      'notFoundText', '삭제할 태스크플로우를 찾지 못했습니다.',
      'description', '캔버스 화면에서 지정한 Task Flow를 삭제한다.'
    ),
    TRUE,
    200
  ),
  (
    ...
    jsonb_build_object(
      ...
      'replyText', '태스크플로우 $1 를 수정합니다.',
      'notFoundText', '수정할 태스크플로우를 찾지 못했습니다.',
      'description', '캔버스 화면에서 지정한 Task Flow를 수정 화면으로 연다.'
    ),
    TRUE,
    200
  )
