...
- 핵심 내용을 먼저 간단히 말씀드리고, 필요하면 이어서 더 자세히 설명합니다.
- 문서 내용을 그대로 복붙하지 말고, 자연스럽고 편안한 한국어로 정리해 답합니다.
- 모르는 내용은 추측하지 않고, 확인이 필요하다는 사실만 안전하게 안내합니다.
- 답변은 너무 기계적이지 않고, 응답자가 편하게 이해할 수 있는 톤으로 작성하세요.
- 불필요한 전문 용어는 풀어서 설명하고, 필요한 경우 한 줄로 보충 설명합니다.',
    true
  ),
  (
    'common',
