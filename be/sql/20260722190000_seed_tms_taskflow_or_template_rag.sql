...
-- TMS Taskflow Canvas용 RAG 템플릿: "or 하나 만들어줘" 요청 처리
...
VALUES (
  ...
  'tms/taskflows',
  'taskflow-canvas',
  'tms-taskflow-template-or-v1',
  'TMS Taskflow OR Template',
  '["or", "오알", "or 하나 만들어줘", "or 예시 만들어줘", "fallback", "taskflow template", "bt xml"]'::jsonb,
  $$
{
  "templateKey": "or",
  "triggerPhrases": [
  ...
  "flowDefinition": {
    ...
    "viewport": { "x": 153.5, "y": 122.25, "zoom": 2 },
    "flowMode": "default"
  },
  "canvasDraft": {
    "layout": "manual",
